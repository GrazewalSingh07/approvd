    ...
    <div>
      ...
      <main className="w-full md:h-screen flex self-center place-content-center place-items-center">
        <div className="w-96 text-gray-600 space-y-5 p-4 shadow-xl border rounded-xl">
          ...
          <p className="text-center  text-sm">Don't have an account? <Link to={'/register'} className="text-blue-500 hover:underline hover:text-blue-500 font-bold">Sign up</Link></p>
